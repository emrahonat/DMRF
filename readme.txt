===================================================
An Efficient MaMIMO-Based Indoor Positioning System
===================================================

Overview
---------
This repository currently includes main.m file.
The purpose of main file is to provide an overview of the academic work and its implementation framework.
All MATLAB files related to the positioning algorithm and method developed in this study will be uploaded after the corresponding paper is accepted for publication.


Contents
--------
main.m: Demonstrates the general structure of the positioning process.
